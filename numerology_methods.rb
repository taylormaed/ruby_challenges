...
def get_message(birth_path_number)
  ...
  when 6
    ...
    Ruled by Venus."
  when 7
    message = "Your numerology number is #{birth_path_mumber}.\nThis is the deep thinker. The number seven is a spiritual vibration. These people are not very attached to material things, are introspective, and generally quiet. Ruled by Neptune."
  when 8
  ...
  when 9
    ...
    message = "Oops! Your numerology number is not 1-9!"
  end

end

 puts "What is your birthdate? Please put it in MMDDYYY format."
birthdate = gets
